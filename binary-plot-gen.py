...
def plot_sorting_times():
    n_values = np.arange(100000, 1100000, 100000)
    
    algorithms = {
        'Linear': 'binary/linear-bin',
        'Insertion': 'binary/insert-bin'
    }
    ...
    plt.savefig('binary-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как 'binary-graph.png'")
