...
def plot_sorting_times():
    ...
    algorithms = {
        'Hoar quick sort': 'hoar-dub',
        'Lomuto quick sort': 'lomut-dub',
        'Thick part quick sort': 'thick-dub'
    }
    ...
    plt.title('Сравнение времени выполнения алгоритмов быстрых сортировок (дубликаты)', 
    ...
    plt.savefig('4-dub-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '4-dub-graph.png'")
