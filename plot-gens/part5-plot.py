...
def plot_sorting_times():
    ...
    algorithms = {
        'Pivot = central': 'hoar-central',
        'Pivot = mediana 3': 'hoar-mediana3',
        'Pivot = random': 'hoar-random',
        'Pivot = mediana of 3 random': 'hoar-random-med'
    }
    ...
    plt.title('Сравнение времени выполнения алгоритмов сортировки Хоара с различными pivot', 
    ...
    plt.savefig('5-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '5-graph.png'")
