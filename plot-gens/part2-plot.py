...
def plot_sorting_times():
    ...
    algorithms = {
        'Bottom-up Heap Sort (2 sons)': 'heap-2',
        'Bottom-up Heap Sort (3 sons)': 'heap-3',
        'Bottom-up Heap Sort (4 sons)': 'heap-4',
        'Bottom-up Heap Sort (5 sons)': 'heap-5',
        'Bottom-up Heap Sort (6 sons)': 'heap-6',
        'Bottom-up Heap Sort (7 sons)': 'heap-7',
        'Bottom-up Heap Sort (8 sons)': 'heap-8',
        'Bottom-up Heap Sort (9 sons)': 'heap-9',
        'Bottom-up Heap Sort (10 sons)': 'heap-10'
    }
    ...
    plt.title('Сравнение времени выполнения пирамидальной сортировки', 
    ...
    plt.savefig('2-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '2-graph.png'")
