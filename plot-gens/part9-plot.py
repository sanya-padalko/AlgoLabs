...
def plot_sorting_times():
    ...
    plt.title('Сравнение времени выполнения алгоритмов сортировок, основанных не на сравнениях', 
    ...
    plt.savefig('9-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '9-graph.png'")
