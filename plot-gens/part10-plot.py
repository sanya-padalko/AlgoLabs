...
def plot_sorting_times():
    ...
    algorithms = {
        ...
        'Heap sort (with 4 sons)' : 'heap-sort',
        'Iterative Merge sort' : 'merge-sort',
        'Hoar\'s quick sort (with Shell)' : 'hoar-sort',
        'Introspective sort' : 'intro-sort',
        'LSD sort' : 'lsd-sort',
        'Base quick sort' : 'quick-sort'
    }
    ...
    plt.title('Сравнение времени выполнения лучших алгоритмов сортировки и Quick Sort', 
    ...
    plt.savefig('10-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '10-graph.png'")
