...
def plot_sorting_times():
    ...
    algorithms = {
        'Recusive merge sort': 'rec-merge',
        'Iterative merge sort': 'iter-merge'
    }
    ...
    plt.title('Сравнение времени выполнения алгоритмов сортировки слиянием', 
    ...
    plt.savefig('3-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '3-graph.png'")
