...
def plot_sorting_times():
    ...
    algorithms = {
        'Hoar quick sort': 'hoar-big',
        'Lomuto quick sort': 'lomut-big',
        'Thick part quick sort': 'thick-big'
    }
    ...
    plt.title('Сравнение времени выполнения алгоритмов быстрых сортировок', 
    ...
    plt.savefig('4-big-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '4-big-graph.png'")
