...
def plot_sorting_times():
    ...
    algorithms = {
        'Len of blocks = 1': 'hoar-shell-1',
        'Len of blocks = 2': 'hoar-shell-2',
        'Len of blocks = 4': 'hoar-shell-4',
        'Len of blocks = 8': 'hoar-shell-8',
        'Len of blocks = 16': 'hoar-shell-16',
        'Len of blocks = 32': 'hoar-shell-32',
        'Len of blocks = 64': 'hoar-shell-64',
        'Len of blocks = 128': 'hoar-shell-128',
        'Len of blocks = 256': 'hoar-shell-256',
        'Len of blocks = 512': 'hoar-shell-512',
    }
    ...
    plt.title('Сравнение времени выполнения алгоритмов сортировки Хоара с использованием сортировки Шелла', 
    ...
    plt.savefig('6-graph.png', dpi=300, bbox_inches='tight')
    print("График сохранен как '6-graph.png'")
